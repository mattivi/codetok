...
'''
        code_lines, comment_lines, blank_lines = count_lines_by_type(css_code, '.css', 'test.css')
...
'''
        code_lines, comment_lines, blank_lines = count_lines_by_type(html_code, '.html', 'test.html')
